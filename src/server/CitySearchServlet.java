...
public class CitySearchServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	try {
    		encodedUrl = URLEncoder.encode(city, "UTF-8");
    	} catch (UnsupportedEncodingException uee) {
    	
    	}
    	URL url = new URL("http://api.openweathermap.org/data/2.5/weather?q=" + encodedUrl + "&units=metric&APPID=9c6b18fff67b226789507070e83f753a");
